...
@section('content')
    <section class="">
        <div class="container">
            <div class="row justify-content-center text-center mt-5 kategori">
                    ...
                    @foreach ($kategori as $data)
                        <div class="element-card">
                            <div class="front-facing text-center">
                                <a href="/list-produk/{{ $data->kategori }}">
                                    <img src="/category-images/{{ $data->gambar_kategori }}" alt="" width="110px"
        ...
        <div class="featured-product product dashboard">
            <div class="container-fluid">
                ...
                @foreach ($total_ung as $item)
                    ...
                    @endphp
                    @if ($total >= 4)
                        <div class="row align-items-center product-slider product-slider-4 wow zoomIn"
                            data-wow-delay="0.1s">
                    ...
                    @else
                        <div class="row align-items-center product-slider product-slider-1 wow zoomIn"
                            data-wow-delay="0.1s">
                            @foreach ($unggulan as $data)
                                <div class="col-sm-3">
                                    <div class="product-item">
