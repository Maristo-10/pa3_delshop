...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center col-12" method="GET" action="/kelola-pesanan/search">
                        ...
                        <tbody class="text-center">
                            ...
                            @foreach ($pesanan_kapem as $index => $data)
                                <tr>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="details-{{$data->id}}" tabindex="-1" aria-labelledby="details-{{$data->id}}" aria-hidden="true">
