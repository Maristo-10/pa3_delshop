...
<div class="card-body d-sm-flex justify-content-between">
    <h6 class="col-md-12 mb-0">
        <a href="/tambah-metode-pembayaran" class="btn btn-success text-white py-2 ml-2">
            <i class="fa fa-plus"></i>
            <span>Tambah Data Metode Pembayaran</span>
        </a>
    </h6>
</div>
<div class="col-7 shadow-sm rounded mt-3 bg-white p-3">
                        ...
                        <tbody>
                            ...
                            @foreach ($metpem as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/ubahproduk/" title="Ubah Data"
                                            class="bi bi-pencil-square btn btn-warning col-md-5 py-2"></a>
                                        <a href="/prosesubahstatusproduk/nonaktif/"
