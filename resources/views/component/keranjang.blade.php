                        ...
                        <tr class="cartpage">
                            <div class="card-body p-3">
                                <div class="row d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="quantity col-md-3 col-lg-3 col-xl-2 d-flex">
                                        ...
                                        <input class="qty-input form-control form-control-sm" id="form1"
                                            min="0" name="jumlah" id="jumlah" value="{{ $item->jumlah }}"
                                            type="number" />
                                    ...
                                    {{-- <div class="cart-grand-total-price col-md-2 col-lg-2 col-xl-2 offset-lg-1">
                                    ...
                                    <div class="row col-md-1 col-lg-3 col-xl-1 mr-4 text-end">
                                        @if ($item->pesanan_id == $pesanan_c->id)
                                            <form action="/remove-checkout/{{ $item->id }}" method="post"
                                                ...
                                                @csrf
                                                <div>
                                                    <i class="col col-2 text-success fs-3 bi bi-bag-check-fill"
                                                        aria-disabled="true" title="Data Sudah Dipilih"></i>
                                                </div>
                                                <div class="mt-2">
                                        ...
                                        @else
                                            <form action="/add-checkout/{{ $item->id }}" method="post"
                                                ...
                                                <button type="submit" class="text-success fs-3"
                                                    name="btnId-{{ $item->id }}" id="btnId-{{ $item->id }}"
                                                    hidden></button>
                                                <div class="mr-1">
