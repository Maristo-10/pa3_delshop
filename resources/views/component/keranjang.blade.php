                                ...
                                <div class="row d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="row col-md-1 col-lg-3 col-xl-1 mr-4 text-end">
                                        ...
                                        <button type="submit" class="text-success fs-3"
                                            ...
                                            hidden></button>
                                        @if ($item->pesanan_id == $pesanan_c->id)
                                            <i class="col col-3 text-success fs-3 bi bi-bag-check-fill" aria-disabled="true" title="Data Sudah Dipilih"></i>
                                            <div class="col col-3 mt-2">
                                            <i class="fas fa-trash fa-lg text-danger ml-2 mr-2" title="Data Sudah Dipilih" aria-disabled="true"></i>
                                            </div>
                                        @else
                                            <div class="col col-3"> <label for="btnId-{{ $item->id }}"
                                                    title="Pilih Produk untuk Checkout"><i
                                                        class="text-success fs-3 bi bi-bag-plus-fill"></i></label></div>
                                                        <div class="col col-3 mt-2">
