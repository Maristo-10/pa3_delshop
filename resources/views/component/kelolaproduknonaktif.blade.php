                            ...
                            <table class="table table-striped table-bordered" id="list">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="col-md-1">Harga</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($produk as $data)
                                        ...
                                        <td>
                                            <a href="/ubahproduk/{{ $data->id_produk }}" title="Ubah Data" class="bi bi-pencil-square btn btn-warning col-md-5 py-2"></a>
                                            <a href="/prosesubahstatusproduk/aktif/{{ $data->id_produk }}"
                                                title="Aktifkan Data" class="bi bi-slash-circle-fill btn btn-danger col-md-5 py-2"></a>
                                        </td>
                                @endforeach
                            </tbody>
                        </table>
