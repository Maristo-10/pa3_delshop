                            ...
                            @foreach ($produk as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="Aktifkan Data" href="/prosesubahstatusproduk/aktif/{{ $data->id_produk }}" class="bi bi-slash-circle-fill btn btn-danger" style="font-size: 8px" ></a>
                                    </td>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-center">
                                                    <a type="button" class="btn btn-danger" href="/prosesubahstatusproduk/aktif/{{ $data->id_produk }}">Hapus</a>
