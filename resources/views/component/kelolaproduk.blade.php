...
<div class="row justify-content-center">
    <div class="col-8 ">
        <div class="card">
            <form action="{{ route('tambahproduk.import') }}" method="POST" enctype="multipart/form-data"
                class="p-3">
                @csrf
                <div class="row nav-content collapse justify-content-center align-items-center mt-4"
                    id="components-laporan-bulanan" data-bs-parent="#form-laporan">
                    ...
                    <div class="col-2 ">
                        <button type="submit" class="btn btn-primary" name="cari-penjualan"
                            id="cari-penjualan">Import</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('items.delete') }}" method="POST">
                        ...
                        <table class="table table-striped table-bordered text-center" id="list">
                            ...
                            <tbody>
                                ...
                                @foreach ($produk as $index => $data)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="selectedItems[]" value="{{ $data->id_produk }}">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @if ($data->status_produk == 'Aktif')
                                                <a title="Non-Aktifkan Data" class="bi bi-slash-circle-fill btn btn-danger"
                                                    style="font-size: 8px" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal2{{ $data->id_produk }}"></a>
                                            @else
                                                <a title="Aktifkan Data" class="bi bi-slash-circle-fill btn btn-success"
                                                    style="font-size: 8px" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal3{{ $data->id_produk }}"></a>
                                            @endif
                                        </td>
                                        <!-- Modal menonaktifkan produk-->
                                        <div class="modal fade" id="exampleModal2{{ $data->id_produk }}" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <a type="button" class="btn btn-danger"
                                                            href="/prosesubahstatusproduk/nonaktif/{{ $data->id_produk }}">Non
                                                            Aktifkan</a>
                                        ...
                                        <!-- Modal mengaktifkan produk-->
                                        <div class="modal fade" id="exampleModal3{{ $data->id_produk }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body text-center">
                                                        Anda yakin akan mengaktifkan data ini.. ?
                                                    </div>
                                                    <div class="modal-footer justify-content-center">
                                                        <a type="button" class="btn btn-success"
                                                            href="/prosesubahstatusproduk/aktif/{{ $data->id_produk }}">Aktifkan</a>
                                                        <button type="button" class="btn btn-primary"
                                                            data-bs-dismiss="modal">Cancel</button>
                                                    </div>
                                                </div>
                        ...
                        <button type="submit" class="btn btn-danger">Non-Aktifkan produk</button>
                    </form>
